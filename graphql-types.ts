...
export type FileFieldsEnum = 
  ...
  | 'childMdx___frontmatter___videoId'
  | 'childMdx___frontmatter___language'
  | 'childMdx___frontmatter___tags'
  | 'childMdx___frontmatter___start'
  | 'childMdx___frontmatter___end'
  | 'childMdx___frontmatter___timezone'
  | 'childMdx___frontmatter___location'
  | 'childMdx___frontmatter___theory'
  | 'childMdx___frontmatter___practice'
  | 'childMdx___body'
  | 'childMdx___excerpt'
  | 'childMdx___headings'
...
export type MdxFieldsEnum = 
  ...
  | 'frontmatter___start'
  | 'frontmatter___end'
  | 'frontmatter___timezone'
  | 'frontmatter___location'
  | 'frontmatter___theory'
  | 'frontmatter___practice'
  | 'body'
  | 'excerpt'
  | 'headings'
  | 'headings___value'
...
export type MdxFrontmatterFilterInput = {
  ...
  theory?: Maybe<StringQueryOperatorInput>;
  practice?: Maybe<StringQueryOperatorInput>;
};
...
export type SitePluginPluginOptions = {
  ...
  injectStyles?: Maybe<Scalars['String']>;
...
export type SitePluginPluginOptionsFilterInput = {
  ...
  injectStyles?: Maybe<StringQueryOperatorInput>;
...
export type LogoImageQuery = { image?: Maybe<{ sharp?: Maybe<{ fluid?: Maybe<GatsbyImageSharpFluid_WithWebpFragment> }> }> };

export type LandingPageImagesQueryVariables = {};


export type LandingPageImagesQuery = { missionImage?: Maybe<{ sharp?: Maybe<{ fluid?: Maybe<GatsbyImageSharpFluid_WithWebpFragment> }> }>, featuresBgImage?: Maybe<{ sharp?: Maybe<{ fluid?: Maybe<GatsbyImageSharpFluid_WithWebpFragment> }> }>, heroBg?: Maybe<{ sharp?: Maybe<{ fluid?: Maybe<GatsbyImageSharpFluid_WithWebpFragment> }> }>, heroImage?: Maybe<{ sharp?: Maybe<{ fluid?: Maybe<GatsbyImageSharpFluid_WithWebpFragment> }> }> };
